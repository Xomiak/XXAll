        ...
        <div class="static-content-wrapper">
            <div class="static-content">
                <div class="page-content">
                    ...
                    <?php include('application/views/admin/'.$type.'/menu.inc.php'); ?>
                    <div data-widget-group="group1">
                        ...
                        <div class="panel panel-1" data-widget='{"draggable": "false"}'>
                            ...
                            <div class="panel-body">
                                ...
                                <div>Эта функция в разработке...</div>
                                                        ...
                                                        <script>
                                                            ...
                                                            $(document).ready(function () {
                                                                $("#sel_type").change(function () {
                                                                    ...
                                                                    if(sel_type == 'url'){
                                                                        $("#inp_url").attr('disabled',false);
                                                                        $("#div-page").hide(300);
                                                                        $("#div-category").hide(300);
                                                                        $("#div-page").val('');
                                                                        $("#div-category").val('');
                                                                    } else{
                                                                        $("#inp_url").attr('disabled',true);
                                                                ...
                                                                <select name="page_id" id="sel_page" class="form-control">
                                                                    ...
                                                                    if($pages){
                                                                        foreach ($pages as $page){
                                                                            ...
                                                                            if($menu['page_id'] == $page['id']) echo ' selected';
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select name="position" class="form-control">
                                                                    ...
                                                                    <option
                                                                        value="top"<?php if ((isset($menu['position'])) && $menu['position'] == 'top')
                                                                        echo ' selected'; ?>>Верхнее
                                                                    </option>
                                                                    <option
                                                                        value="top2"<?php if ((isset($menu['position'])) && $menu['position'] == 'top2')
                                                                        echo ' selected'; ?>>Верхнее 2
                                                                    </option>
                                                                    <option
                                                                        value="left"<?php if ((isset($menu['position'])) && $menu['position'] == 'left')
                                                                        echo ' selected'; ?>>Левое
                                                                    </option>
                                                                    <option
                                                                        value="right"<?php if ((isset($menu['position'])) && $menu['position'] == 'right')
                                                                        echo ' selected'; ?>>Правое
                                                                    </option>
                                                                    <option
                                                                        value="bottom"<?php if ((isset($menu['position'])) && $menu['position'] == 'bottom')
                                                                        echo ' selected'; ?>>Нижнее
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>

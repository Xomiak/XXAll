                        ...
                        <div class="panel panel-1" data-widget='{"draggable": "false"}'>
                            ...
                            <div class="panel-body">
                                ...
                                <form enctype="multipart/form-data" action="<?= $_SERVER['REQUEST_URI'] ?>"
                                      method="post" class="form-horizontal row-border" id="validate-form" data-parsley-validate>
...
//vd($article);
                                                      ...
                                                      //  if ($languagesCount > 1) {
                                                        ...
                                                        <div class="form-group fixed-buttons">
                                                            ...
                                                            <input class="btn form-submit save_and_close" type="submit"
                        ...
                        <?php if (isset($article)) include X_PATH."/application/views/admin/articles/adding-images.inc.php"; ?>

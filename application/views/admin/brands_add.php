    ...
    <tr>
        ...
        <td valign="top">
            ...
            <div class="content">
                ...
                <form enctype="multipart/form-data" action="/admin/brands/add/" method="post">
<input type="hidden" name="num" value="<?=$num?>" />
			...
			<tr>
                            <td>SEO:</td>
                            <td><textarea name="seo" class="ckeditor" rows="30"><?php if(isset($_POST['seo'])) echo $_POST['seo'];?></textarea></td>
                        </tr>

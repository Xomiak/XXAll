                            ...
                            <div class="row">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <SELECT id="sel_parent" name="parent" class="form-control">
                                                <option value="0">- нет -</option>
                                                <?php
                                                $optionsTree = new AdminElementsTree('category');
                                                $optionsTree->setSelectedOptions($cat['parent']);
                                    ...
                                    include(X_PATH.'/application/views/admin/categories/multilanguage.inc.php');
                                    ?>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">
                                            URL:
                                        ...
                                        <div class="col-sm-8">
                                            <input id="inp_url" class="form-control" type="text" name="url"
                                                   value="<?php if (isset($cat['url'])) echo $cat['url']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <SELECT id="inp_type" name="type" required class="form-control">
                                                <option value="">- Тип раздела -</option>
                                                <option
                                                    value="articles"<? if (isset($cat['type']) && $cat['type'] == 'articles')
                                                    echo ' selected'; ?>>Статьи
                                                </option>
                                                <option
                                                    value="products"<? if (isset($cat['type']) && $cat['type'] == 'products')
                                                    echo ' selected'; ?>>Товары
                                                </option>
                                                <option
                                                    value="gallery"<? if (isset($cat['type']) && $cat['type'] == 'gallery')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="inp_num" class="form-control" type="number" name="num"
                                                   style="width: 140px"
                                                   value="<?php if (isset($cat['num'])) echo $cat['num']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <SELECT id="category_templates" name="template" required class="form-control">
<!--                                                <option value="">- нет -</option>-->
                                                <?php
                                                if(isset($cat)){
                                                    $this->load->helper('file');
                                                    $files = get_filenames(X_PATH.'/application/views/'.SITE.'/templates/categories/'.$cat['type'].'/');
                                                    $count = count($files);
                                                        sort($files);
                                                        for ($i = 0; $i < $count; $i++) {
                                                            echo '<option value="' . $files[$i] . '"';
                                                            if (isset($cat['template']) && $cat['template'] == $files[$i])
                                                                echo ' selected';
                                                            echo '>' . $files[$i] . '</option>';
                                                        }
                                                }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <SELECT id="content_templates" name="content_template" required class="form-control">
<!--                                                <option value="">- нет -</option>-->
                                                <?php
                                                if(isset($cat)){
                                                    $this->load->helper('file');
                                                    $files = get_filenames(X_PATH.'/application/views/'.SITE.'/templates/'.$cat['type'].'/');
                                                    $count = count($files);
                                                    sort($files);
                                                    for ($i = 0; $i < $count; $i++) {
                                                        echo '<option value="' . $files[$i] . '"';
                                                        if (isset($cat['content_template']) && $cat['content_template'] == $files[$i])
                                                            echo ' selected';
                                                        echo '>' . $files[$i] . '</option>';
                                                    }
                                                }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            if (isset($cat['image']) && $cat['image'] != '') {
                                                echo '<img src="' . $cat['image'] . '" style="max-width:600px" /><br /><input type="checkbox" name="image_del">Удалить<br />';
                                                echo '<input type="text" class="form-control" name="icon" value="http://' . $_SERVER['SERVER_NAME'] . $cat['image'] . '" />';
                                            }
                                            echo '
                                            ...
                                            if (isset($cat['image']) && $cat['image'] != '') echo 'другой ';
                                            echo 'файл</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <?php
                                            if (!empty($cat['filters_id'])) {
                                                $cat['filters_id'] = explode('|', $cat['filters_id']);
                                            }
                                            for ($i = 0; $i < count($filters); $i++) {
                                                ...
                                                if (!empty($cat['filters']))
                                                    foreach ($cat['filters'] as $f)
                                                        $cat['filters_id'][] = $f['id'];
                                                getMultilangHtmlTags($filters[$i]['title'], 'input', 'filters[]', 'checkbox', (!empty($cat['filters']) && in_array($filters[$i]['id'], $cat['filters_id'])) ? 'checked' : '', $filters[$i]['id']);
                                                echo '<br />';
                                                if (!$div && $i % 5 == 0) {
                                                    echo '</div>';
                                                }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="checkbox" id="inp_active" name="active"
                                                <?php
                                                if ((isset($cat['active']) && $cat['active'] == 1) || !isset($cat)) echo ' checked ';
                                                ?>
        ...
        <?php if (isset($category)) include X_PATH."/application/views/admin/categories/adding-images.inc.php"; ?>

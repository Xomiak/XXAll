...
<?=getHeader()?>
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
                            <h1 class="carousel-title">Будь в ТОПе!</h1>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="carousel-centered">
                        <div class="margin-b-40">
                            <h2 class="carousel-title">Будь в ТОПе!</h2>
                            <p>Lorem ipsum dolor amet consectetur adipiscing dolore magna aliqua <br/> enim minim estudiat veniam siad venumus dolore</p>
                        </div>
                        <a href="/#" class="btn-theme btn-theme-sm btn-white-brd text-uppercase">Explore</a>
                    </div>
    ...
    <div class="promo-section overflow-h">
                ...
                <div class="ver-center">
                    <div class="ver-center-aligned">
                        <div class="promo-section-col">
                            ...
                            <p>Каждый человек хочет почувствовать себя победителем и выделиться из толпы. Если у Вас есть такое желание, то с нашей помощью Ваши шансы увеличатся многократно!</p>
                            <p>Мы предлагаем не просто накрутку, а "живое" увеличение голосов!</p>
                            <p>Вы платите, а за Вас голосуют <b>реальные люди</b>! Никаких взломов, договорённостей и прочей "чёрной" методики. Всё честно и прозрачно. В личном кабинете Вы будете видеть подробную статистику: сколько голосов Вы оплатили и сколько из них уже проголосованы.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="promo-section-img-right">
            <img class="img-responsive" src="/img/first.jpg" alt="Content Image">
        </div>
    </div>
    </div>
    <!-- End Promo Section -->
    ...
    <!-- Pricing -->
    <div class="bg-color-sky-light overflow-h">
    <section id="pricePlans" class="bg-color-sky-light">
        <ul id="plans">
            <li class="plan">
                <ul class="planContainer">
                    <li class="title"><h2>10 голосов</h2></li>
                    <li class="price"><p>$10</p></li>
                    <li>
                        <ul class="options">
            ...
            <li class="plan">
                <ul class="planContainer">
                    <li class="title"><h2 class="bestPlanTitle">25 голосов</h2></li>
                    <li class="price"><p class="bestPlanPrice">$20</p></li>
                    <li>
                        <ul class="options">
                            <li>2x <span>option 1</span></li>
                            <li>Free <span>option 2</span></li>
            ...
            <li class="plan">
                <ul class="planContainer">
                    <li class="title"><h2>50 голосов</h2></li>
                    <li class="price"><p>$30</p></li>
                    <li>
                        <ul class="options">
                            <li>2x <span>option 1</span></li>
                            <li>Free <span>option 2</span></li>
            ...
            <li class="plan">
                <ul class="planContainer">
                    <li class="title"><h2>100 голосов</h2></li>
                    <li class="price"><p>$40</p></li>
                    <li>
                        <ul class="options">
                            <li>2x <span>option 1</span></li>
                            <li>Free <span>option 2</span></li>
